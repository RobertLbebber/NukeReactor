...
class PageBuilder extends React.Component {
  constructor(props) {
    super(props);
    let currenAccount = devvar.Debug.ACTIVE ? { id: 1 } : props.account;
    //TODO add urls
    this.state = {
      // loading: true,
      storageManager: {
        type: "remote",
        stepsBeforeSave: 3,
        urlStore: Endpoints.PageBuilder.save(currenAccount.id, 1).url,
        urlLoad: Endpoints.PageBuilder.load(currenAccount.id, 1).url,
...
PageBuilder.propTypes = {
  ...
  account: devvar.Debug.ACTIVE ? PropTypes.object : PropTypes.object.isRequired
};
