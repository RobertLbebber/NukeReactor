        ...
        return (
            <ul id="header-notifications-custom-popover-content">
                {_.map(this.props.items, (item) => (
                    <li className={`slds-global-header__notification ${item.unread ? 'slds-global-header__notification_unread' : ''}`}
                            ...
                            <div className="slds-media__body">
                                <div className="slds-grid slds-grid_align-spread">
                                    ...
                                    >
                                        ...
                                        <p className="slds-truncate" title={item.comment}>{item.comment}</p>
